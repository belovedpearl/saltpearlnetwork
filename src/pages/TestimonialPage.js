  ...
  return (
    <div className={styles.testimonialpage}>
      <header className={styles.testimonialheader}>
        <h1>Stories of Hope and Impact</h1>
        <p>See how your contributions are changing lives for the better.</p>
      </header>
      ...
      <footer className={styles.testimonialfooter}>
        <p>Want to make a difference? <a href="/support">Donate now</a> or <a href="/volunteer">Join us as a volunteer!</a></p>
      </footer>
    </div>
  );
};
